            ...
            <div class="row gx-lg-5">
                <div class="col-lg-6 pr-lg-10">
                    <div class="footer-widget footer-widget-1">
                        <h2 class="mb-4 text-ebony-clay">PR Group</h2>
                        ...
                        <div class="col-lg-4">
                            <div class="footer-widget footer-widget-4">
                                <ul>
                                    ...
                                    <li><a
                                            href="https://energeticthemes.com/templates/PR Group/page-contact-us.html">Press</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="footer-widget">
                        <ul class="list-inline m-lg-0 p-lg-0 text-md-right footer-nav">
                            <li><a href="https://energeticthemes.com/templates/PR Group/page-privacy-terms.html">Privacy
                                    Policy</a></li>
                            <li><a href="https://energeticthemes.com/templates/PR Group/page-privacy-terms.html">Terms
                                    & Conditions</a></li>
                            ...
                            <li class="list-inline-item py-2 pr-2"><a href="#"><i class="fab fa-twitter icon"></i></a>
                            </li>
                            <li class="list-inline-item py-2 pr-2"><a href="#"><i class="fab fa-instagram icon"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
